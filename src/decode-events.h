...
enum {
    ...
    /* END OF DECODE EVENTS ON SINGLE PACKET */    /* 以上为单包解析事件 */
    DECODE_EVENT_PACKET_MAX = CHDLC_PKT_TOO_SMALL, /* 后续为流检测事件 */
    ...
    STREAM_SUSPECTED_RST_INJECT,    /* 怀疑有RST注入, 强行关闭链路 */
    STREAM_WRONG_THREAD,

    STREAM_REASSEMBLY_SEGMENT_BEFORE_BASE_SEQ,
    STREAM_REASSEMBLY_NO_SEGMENT,
    STREAM_REASSEMBLY_SEQ_GAP,      /* TCP重组时, 有数据空洞 */
